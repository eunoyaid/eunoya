...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="wrapper  fixed z-10 left-0 right-0 flex justify-between bg-white p-4 rounded-lg w-[90%] mx-auto mt-4 font-nunito">
        <div className="left">
          <Link to="/">Eunoya</Link>
        </div>
        <div className="right flex gap-8">
          ...
          <div className="icons flex gap-3 items-center ">
            ...
            <div className="card-icon flex items-center gap-1 relative">
              ...
              />
              <Badge className="rounded-full bg-opacity-60 text-[10px] top-[-10px] absolute right-[-18px]">
                0
              </Badge>
            </div>
          </div>
