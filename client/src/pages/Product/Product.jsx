...
import { AiFillEye, AiFillPlayCircle, AiOutlineCheckCircle } from "react-icons/ai";
          ...
          <div className="product-img ">
            <div className="main-img relative rounded-lg w-full h-[445px] object-cover bg-gray-500 ">
             ...
             <button className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-pulse ">
               ...
               <AiFillEye   className="h-10 w-10 text-primary"/>
             </button>
             }
          ...
          <div className="card-desc h-fit rounded-lg border-border-card border p-5 bg-white ">
            ...
            <div className="mt-5 add-to-cart w-full flex gap-2 items-center">
              <button
                ...
                className=" bg-primary flex-3/4 w-full  justify-center text-white [&>svg]:fill-white rounded-xl py-3 px-4 flex"
              >
                <svg
                  width="20"
                  height="21"
              ...
              <button className=" bg-card text-white flex-auto justify-center [&>svg]:fill-white rounded-xl py-3 px-4 flex">
                <svg
                  width="26"
                  height="22"
                  viewBox="0 0 26 22"
